...
var editMode = function() {
  if ($('#articlerow').length > 0) {
    $('<div id="articleeditor" style="display: none; height: 480px;"><div class="row" id="articleeditframe" style="height: 448px; opacity: 0;"><div class="span16"><div id="edit" style="width:935px; height:450px">' + $('#articlecontent').html() + '</div><br style="clear:both" /></div></div><hr /></div>').insertBefore('#articlerow');
