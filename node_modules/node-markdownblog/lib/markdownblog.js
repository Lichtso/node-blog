...
exports.updateArticle = function(id, data) {
  ...
  var fd = fs.openSync(curItem.directory+'article.md', 'w+', 0666);
...
exports.createNewArticle = function(name) {
  ...
  var fd = fs.openSync(newFile+'article.md', 'w+', 0666);
...
exports.parseFile = function(b) {
  ...
  var md = fs.readFileSync(directory+'article.md')+'';
  var c=md.split('*/'),d=c[0].substr(3),e=c[1],f=y.decode(d),g=[],h=f.Sources||{};
